...
#             print(
#                 f"{response['PendingRequests'][0]['WorkspaceId']} Created")
#         else:
#             print(
#                 f"{response['FailedRequests'][0]['WorkspaceRequest']['UserName']} failed")
#     except ClientError as e:
#         print(f"Term Error for WorkspaceId: {user}: {e}")
#     except Exception as e:
#         print(f"Another error with {user} | Error: {e}")
